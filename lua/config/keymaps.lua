...
-- better escape
map("i", "jk", vim.cmd.stopinsert, { desc = "Better escape" })
map("i", "jl", "<RIGHT>", { desc = "Move right" })
map("i", "jh", "<LEFT>", { desc = "Move left" })
...
map("n", "<leader>c", "<cmd>:bd!<cr>", { desc = "Delete Buffer and Window" })
-- map("n", "<leader><leader>c", "<cmd>:bd!<cr>", { desc = "Delete! Buffer and Window" })
